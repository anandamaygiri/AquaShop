...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["title", "slug", "category", "image", "marked_price",
                  "selling_price", "description", "mfg_date", "expiry_date","quantity"]
        ...
        widgets = {
            ...
            "mfg_date": forms.TextInput(attrs={
                "class": "form-control",
                "placeholder": "Enter the product manufacture date here..."
            }),
            "expiry_date": forms.TextInput(attrs={
                "class": "form-control",
                "placeholder": "Enter the product expiry date here..."
            }),
